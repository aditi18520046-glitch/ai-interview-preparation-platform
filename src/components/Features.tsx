      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, idx) => (
          <motion.div
            ...
            className="p-6 rounded-2xl bg-slate-900/50 border border-white/5 hover:border-indigo-500/30 transition-all hover:-translate-y-1 cursor-pointer group shadow-lg hover:shadow-indigo-500/10"
          >
            <Link to={getFeatureLink(feature.path)} className="block h-full">
