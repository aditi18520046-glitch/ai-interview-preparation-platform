...
export default function Leaderboard() {
  ...
  return (
    <div className="bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-[20px] p-6 h-full min-h-[280px] flex flex-col relative overflow-hidden group shadow-sm">
      ...
      <Link to="/dashboard/leaderboard" className="w-full mt-4 py-2 bg-white/5 hover:bg-white/10 text-white text-[12px] font-medium rounded-xl transition-all flex items-center justify-center gap-1.5 border border-transparent hover:border-white/5 relative z-10 shrink-0">
